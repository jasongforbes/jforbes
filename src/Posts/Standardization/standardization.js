    ...
    <React.Fragment>
      ...
      <React.Fragment>
        ...
        <Typography variant="body1">
          ...
          prototype. A more cost-effective sensor is in the production units. The specs are
          different and the training-set is exclusively generated by the expensive sensor. Can the
          change of sensor cause the issue?
        </Typography>
        <Typography variant="body1">
          This is the kind of issue standardization solves. Visualizing the time series helps with
        ...
        <Typography variant="body1">
          The second effect is more subtle. The signal generated by the low-end sensor varies less
          than the original. This is due to the sensitivity of the sensor. In speech recognition, it
        ...
        <Typography variant="body1">
          ...
          speaker walks towards the sensor, the signal strength increases.
        </Typography>
        <Typography variant="body1">
        ...
        <Typography variant="body1">
          ...
          vectorizing an algorithm replaces <em>for loops</em> with optimized vector operations.
          These vectorized operations rely on the underlying linear-algebra library, such as BLAS.
