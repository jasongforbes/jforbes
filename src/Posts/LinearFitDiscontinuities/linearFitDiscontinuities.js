  ...
  return (
    <MathJax.Provider>
      ...
      <React.Fragment>
        ...
        <MathJax.Node className={classes.math} formula="y = Ax" />
        <Typography variant="body1">
          Keeping with the example, <MathJax.Node inline formula="A" /> is a measure of the
          malfunctioning clock speed as compared to a working clock.{' '}
          <MathJax.Node inline formula="x" />, the input, is the actual time.{' '}
          <MathJax.Node inline formula="y" /> is the time shown by the clock. It should be pretty
          easy to see that if <MathJax.Node inline formula="A = 1" />, then{' '}
          <MathJax.Node inline formula="y = x" />, and the clock runs neither fast nor slow.
        </Typography>
        <Typography variant="body1">
          A random variable <MathJax.Node inline formula={'\\tilde \\mu(x)'} /> models the noise in
          the output due to errors in the observation process. In this post, random variables are
          shown with the <MathJax.Node inline formula={'\\tilde \\cdot'} /> symbol.
        </Typography>
        ...
        />
        <Typography variant="body1">
          Our goal now is to find an estimate for <MathJax.Node inline formula="A" />.
        </Typography>
        ...
        <Typography variant="body1">
          ...
          The qualifier &quot;real&quot; here means &quot;not imaginary&quot;. In this context,
          amplitude defines the height of the wave and phase defines the &quot;starting-point&quot;.
          Each harmonic has a constant frequency <MathJax.Node inline formula={'\\omega'} /> related
        ...
        />
        <Typography variant="body1">
          The output of the Fourier Transform, <MathJax.Node inline formula={'F(\\omega)'} />,
          describes the amplitude and phase of the harmonic at frequency{' '}
          <MathJax.Node inline formula={'\\omega'} />. The amplitude and phase are also represented
          as a complex number. Under certain circumstances this can completely define a real
          harmonic:
        </Typography>
        <MathJax.Node
          className={classes.math}
        ...
        <Typography variant="body1">
          ...
          transformation is to change the discontinuity point by scaling the model.
        </Typography>
        <Typography variant="body1">
        ...
        <Typography variant="body1">
          ...
          recover the desired solution <MathJax.Node inline formula="A" /> by undoing the scaling.
        </Typography>
        <Typography variant="body1">
        ...
        <Typography variant="body1">
          ...
          value of <MathJax.Node inline formula="A" />.
        </Typography>
        ...
        <Typography variant="body1">
          ...
          <MathJax.Node inline formula={'\\phi = 2\\pi A / b'} />. Determine the location of the
          spike by searching the FFT data. Lastly, convert the frequency back to clock-speed using
          the inverse scaling factor <MathJax.Node inline formula="1/c" />.
        </Typography>
        <Highlight language="javascript">
