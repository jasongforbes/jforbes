...
const Privacy = () => (
  <FullPage>
    ...
    <Typography variant="body1">
      ...
      that we transfer the data, including Personal Data, to Canada and process it there.
    </Typography>
    <Typography variant="body1">
    ...
    <Typography variant="body1">
      Jason Forbes will take all steps reasonably necessary to ensure that your data is
    ...
    <Typography variant="body1">
      Jason Forbes may disclose your Personal Data in the good faith belief that such
    ...
    <Typography variant="body1">Our Service does not address anyone under the age of 18 (&quot;Children&quot;).</Typography>
    <Typography variant="body1">
      ...
      us with Personal Data, please contact us. If we become aware that we have collected Personal
